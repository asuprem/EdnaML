import unicodedata
from ednaml.utils.tokenizers import whitespace_tokenize, load_vocab, encode_pieces, convert_by_vocab, _is_control, _is_punctuation, _is_whitespace
...
class AlbertFullTokenizer(object):
  ...
  def __init__(self, vocab_file, do_lower_case=True, spm_model_file=None):
    ...
    if spm_model_file:
      ...
      self.wordpiece_tokenizer = AlbertWordpieceTokenizer(vocab=self.vocab,unk_token="[UNK]", max_input_chars_per_word=100)
