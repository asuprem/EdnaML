...
class BaseTrainer: 
    ...
    def setup(self, step_verbose:int = 5, save_frequency:int = 5, test_frequency:int = 5, \
                save_directory:str = './checkpoint/', save_backup:bool = False, backup_directory:str = None, gpus:int=1,\
                fp16:bool = False, model_save_name:str = None, logger_file:str = None):
