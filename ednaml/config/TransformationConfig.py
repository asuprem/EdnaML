...
class TransformationConfig:
    ...
    def __init__(self, transformation_dict, defaults: ConfigDefaults):
        ...
        self.NORMALIZATION_MEAN = transformation_dict.get("NORMALIZATION_MEAN", defaults.NORMALIZATION_MEAN)
        self.NORMALIZATION_STD = transformation_dict.get("NORMALIZATION_STD", defaults.NORMALIZATION_STD)
        self.NORMALIZATION_SCALE = transformation_dict.get("NORMALIZATION_SCALE", defaults.NORMALIZATION_SCALE)
        self.H_FLIP = transformation_dict.get("H_FLIP", defaults.H_FLIP)
        self.T_CROP = transformation_dict.get("T_CROP", defaults.T_CROP)
        self.RANDOM_ERASE = transformation_dict.get("RANDOM_ERASE", defaults.RANDOM_ERASE)
        self.RANDOM_ERASE_VALUE = transformation_dict.get("RANDOM_ERASE_VALUE", defaults.RANDOM_ERASE_VALUE)
